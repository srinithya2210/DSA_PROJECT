...
public class Unmute {
    ...
    static Stack<VentEntry> ventStack=new Stack<>();
    ...
    public static void main(String[] args){
        ...
        while(true){
            ...
            System.out.println("7. Remove Latest Vent (Stack Pop)");
    ...
    static void vent(){
        ...
        VentEntry v = new VentEntry(date,msg,mood);
    ...
    // STACK POP FUNCTION
    static void removeLatestVent(){

        if(ventStack.isEmpty()){
            System.out.println("No vents to remove.");
            return;
        }

        VentEntry v = ventStack.pop();
